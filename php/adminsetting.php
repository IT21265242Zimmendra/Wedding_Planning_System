...
<html>
    <!-----------------------HTML------------------------------------>
        <head>
            <link rel="stylesheet" href="./../css/adminsetting.css?v=<?php echo time(); ?>"><!-----------Link the css file---------->
        </head>

    <body>
        <div class="container">
            <nav>
                <img src = "./../images/logo.png" class = "logo"><!--------------LOGO--------------->
                <div class = "details">
                    <img src = "./../images/pro.png" class = "logo1"><!---------------user image-------------->
                
                    <a href = "#"><?php echo $name ?></a><!------------------Display the user name----------------------->
